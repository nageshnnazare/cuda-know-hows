...
> Part of **[CUDA Know-Hows](README.md)**. Prev: [17 — Multi-GPU](17_multi_gpu.md).
> Next: [19 — Optimization case studies](19_optimization_case_studies.md). How to
> *measure* everything the earlier chapters described — Nsight Systems/Compute,
> `compute-sanitizer`, `cuda-gdb`, metrics interpretation, plus a testing guide.
